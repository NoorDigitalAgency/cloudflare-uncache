...
function run() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const token = (0, core_1.getInput)('api_token');
            (0, core_1.debug)(`Token: '${token}'`);
            const domain = (0, core_1.getInput)('domain');
            ...
            if (!zonesResponse.success || zonesResponse.result_info.count !== 1) {
                ...
                (0, core_1.endGroup)();
                (0, core_1.warning)('Could not get the zone id.');
                return;
            }
            ;
            const id = (_a = zonesResponse.result.pop()) === null || _a === void 0 ? void 0 : _a.id;
            (0, core_1.debug)(`Zone id: ${id}`);
            const purgeResponse = (yield axios_1.default.post(`https://api.cloudflare.com/client/v4/zones/${id}/purge_cache`, { purge_everything: true }, { headers })).data;
            if (!purgeResponse.success)
                (0, core_1.warning)('Could not Purge the Cache.');
            const settingsResponse = (yield axios_1.default.patch(`https://api.cloudflare.com/client/v4/zones/${id}/settings/development_mode`, { value: "on" }, { headers })).data;
...
module.exports = function () {
  if (!debug) {
    try {
      ...
      debug = __nccwpck_require__(7143)("follow-redirects");
    }
    catch (error) { /* */ }
